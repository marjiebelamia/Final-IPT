<div class="div col-md-11">
    @include('livewire.modals.modal')
        ...
        <div class="post-body col-md-12 mt-2">
            <div class=" offset-3 " >
                <div class=" shadow-md p-3 " style="width:200px; margin-left: 10px;">
                    <button class="write-2 form-control" style="color:white;background-color: #1e1f21;" data-toggle="modal" data-target="#click"><span class="fas fa-plus-circle"></span></button>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10 mt-1" >
                        <div class="card shadow-md mt-3" id="cardd">
                            <div class="card-header" style="background-color: #27292b;">
                               
                                @if($post->isEditable())
                                <span id="dot-icon" class="float-end dropdown dropstart" style="background-color:#2d3034">
...
<style>
      ...
      .f1 {
            background-color: rgb(201, 255, 8);
        }
        .m1 {
            background-color: rgb(128, 126, 135);
        }
    #text-area {
        border: none;
        background-color: ;
