<div class="container col-md-12">
    ...
    <div class="post-body col-md-12 mt-2">
        <div class="offset-3">
            ...
            @endif
            <select class="form-select mb-1" style="background-color:#2f3336; width: 300px;" id="searchh" wire:model.lazy="title">
            ...
            <div class="row">
                @foreach ($recents as $recent)
                    <div class="col-md-8 mt-1" >
                        <div class="card">
                            <div class="card-header" style="background-color: #2f3235;" id="cardd">
                                @role('admin')
