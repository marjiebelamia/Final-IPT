<div>
    ...
    <div wire.ignore.self class="modal fade" id="click" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content" style="background-color: #303235;" id="modall">
                <div class="modal-header text-center" style="background-color: #303235;">
            ...
            <br>
                ...
                <div class="modal-footer bg-light">
                        <button type="button" id="submit-button" class="btn form-control" style="background-color: #303235; color:white; width: 150px;" wire:click="addPost()"> Post</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div wire:ignore.self class="modal fade" id="click-edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content" style="background-color: #303235;" id="modall">
                ...
                <br>
                <div class="modal-footer bg-light">
                    <button type="button" id="submit-button" class="btn form-control" style="width: 200px; background-color:#303235; color:white;" wire:click="updatePosts()"> Update Post</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div wire:ignore.self class="modal fade" id="click-edit-recent" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            ...
            <br>
            <select name="title" class="form-select bg-light shadow-md" style="width: 200px; margin-left: 10px;" id="rm" wire:model.defer="title">
                <option hidden="true">Choose Category...</option>
                <option value="Business">Business</option>
                <option value="Education">Education</option>
                <option value="Comedy">Comedy</option>
            ...
            <br>
            <div class="modal-footer bg-light">
                <button type="button" id="submit-button"   class="btn form-control" style="background-color: #303235; color:white; width: 150px;" wire:click="updatePosts()"> Update Post</button>
            </div>
            </div>
        </div>
    </div>
